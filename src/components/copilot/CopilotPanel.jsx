...
const quickPrompts = [
    ...
    { icon: CalendarCheck, label: 'Lịch phỏng vấn sắp tới', message: 'Cho tôi xem lịch phỏng vấn sắp tới của tôi.', color: 'from-sky-50 to-sky-100/60 text-sky-700 border-sky-200/80 hover:border-sky-300' },
    { icon: Briefcase, label: 'Việc làm phù hợp nhất', message: 'Tìm các việc làm phù hợp nhất với hồ sơ của tôi.', color: 'from-amber-50 to-amber-100/60 text-amber-700 border-amber-200/80 hover:border-amber-300' },
    { icon: Lightbulb, label: 'Kiểm tra trạng thái xin việc', message: 'Xem thông tin trạng thái các đơn ứng tuyển của tôi', color: 'from-violet-50 to-violet-100/60 text-violet-700 border-violet-200/80 hover:border-violet-300' },
];
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full px-5 py-6 copilot-welcome-fadein">
            ...
            <p className="text-xs text-gray-500 text-center mb-6 max-w-[240px] leading-relaxed">
                Trợ lý AI thông minh giúp bạn tìm kiếm việc làm và chuẩn bị phỏng vấn tốt hơn
            </p>
