...
const ElegantSerifTemplate = ({ cvData }) => {
  ...
  const renderSummary = () => {
    ...
    return (
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-800 mb-4 font-serif border-b border-gray-300 pb-2">
  ...
  const renderExperience = () => {
    ...
    return (
      <section className="mb-10">
        <h2 className="text-2xl font-bold text-gray-800 mb-6 font-serif border-b border-gray-300 pb-2">
  ...
  return (
    <div className="a4-size w-full max-w-4xl mx-auto bg-white shadow-lg print:shadow-none print:max-w-none" style={{ fontFamily: 'Georgia, serif' }}>
      {/* Header */}
