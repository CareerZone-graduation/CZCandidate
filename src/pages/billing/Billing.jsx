  ...
  return (
    <div className="w-full min-h-[calc(100vh-80px)] flex items-center justify-center p-4 md:p-8 bg-muted/30">
      <Card className="w-full max-w-4xl shadow-lg">
        <CardHeader>
          <CardTitle>Nạp Xu vào tài khoản</CardTitle>
          <CardDescription>Chọn gói xu và phương thức thanh toán để sử dụng các tính năng cao cấp.</CardDescription>
        </CardHeader>
        <CardContent className="grid md:grid-cols-3 gap-8 pt-6">
          ...
          <div className="md:col-span-1 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* Note: Bạn cần tạo component RadioGroup và Label nếu chưa có */}
